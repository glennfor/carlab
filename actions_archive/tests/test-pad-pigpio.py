...
PWM_FREQUENCY = 100         # Stable frequency for RPi.GPIO
...
def setup_gpio():
    """Initializes the RPi.GPIO and sets up pins."""
    print("Setting up GPIO...")
    global m1_pwm, m2_pwm, m3_pwm
    ...
    m1_pwm = GPIO.PWM(M1_PWM_PIN, PWM_FREQUENCY)
    m2_pwm = GPIO.PWM(M2_PWM_PIN, PWM_FREQUENCY)
    m3_pwm = GPIO.PWM(M3_PWM_PIN, PWM_FREQUENCY)
...
def control_loop():
    ...
    while running_event.is_set():
        ...
        set_motor_speed(M1_PWM_PIN, M1_IN1_PIN, M1_IN2_PIN, m1_cmd, m1_pwm)
        set_motor_speed(M2_PWM_PIN, M2_IN1_PIN, M2_IN2_PIN, m2_cmd, m2_pwm)
        set_motor_speed(M3_PWM_PIN, M3_IN1_PIN, M3_IN2_PIN, m3_cmd, m3_pwm)
        
        time.sleep(POLL_DELAY)
        
    # Stop motors upon exit
    set_motor_speed(M1_PWM_PIN, M1_IN1_PIN, M1_IN2_PIN, 0, m1_pwm)
    set_motor_speed(M2_PWM_PIN, M2_IN1_PIN, M2_IN2_PIN, 0, m2_pwm)
    set_motor_speed(M3_PWM_PIN, M3_IN1_PIN, M3_IN2_PIN, 0, m3_pwm)
